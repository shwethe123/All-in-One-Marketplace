...
import { Button } from "@/components/ui/button_s";
import {
  Card,
  CardContent,
  CardDescription,
...
export const LoginPage = () => {
  ...
  // --- Google Login အတွက် Function အသစ် ---
  const signInWithGoogle = async () => {
    if (!isLoaded) return;
    try {
      await signIn.authenticateWithRedirect({
        strategy: 'oauth_google',
        redirectUrl: '/sso-callback', // Clerk က handle လုပ်ဖို့ callback URL
        redirectUrlComplete: '/',    // Login ပြီးရင် ပြန်လာမယ့် URL
      });
    } catch (err) {
